...
const upcomingEvents = [
  ...
  },
  {
    ...
    date: "Today",
    image: "https://images.unsplash.com/photo-1526399743290-f73cb4022f48?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZmFybWVycyUyMG1hcmtldHxlbnwwfHwwfHx8MA%3D%3D",
    isGoing: null,
  },
];
...
const defaultChatMessages: Array<{ id: number; sender: string; message?: string; image?: string; time: string; type: 'text' | 'image' }> = [
  { id: 1, sender: "John Doe", message: "Hey everyone! Who's up for a park visit this weekend?", time: "10:30 AM", type: 'text' },
  { id: 2, sender: "Riya Patel", message: "I'm in!", time: "10:32 AM", type: 'text' },
  { id: 3, sender: "Juan Sancho", message: "Sounds great! What time?", time: "10:35 AM", type: 'text' },
  { id: 4, sender: "Lisa Chen", message: "4pm works for me!", time: "10:40 AM", type: 'text' },
];
