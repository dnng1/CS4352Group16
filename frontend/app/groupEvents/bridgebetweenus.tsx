...
const groupMembers = [
  ...
  { id: 3, name: "Carlos Castillo", avatar: "https://i.pravatar.cc/150?img=3", online: true },
  { id: 4, name: "Yousuf Haddad", avatar: "https://i.pravatar.cc/150?img=4", online: true },
  { id: 5, name: "Angela Nguyen", avatar: "https://i.pravatar.cc/150?img=5", online: false },
  { id: 6, name: "Rose Sanchez", avatar: "https://i.pravatar.cc/150?img=6", online: false },
  { id: 7, name: "Maya Lee", avatar: "https://i.pravatar.cc/150?img=7", online: false },
];

const newEvents = [
  {
    id: 22,
    title: "Migration Story Picnic",
...
const upcomingEvents = [
  {
    id: 24,
    title: "City research - talk about places discovered",
    location: "Online",
...
const defaultChatMessages: Array<{ id: number; sender: string; message?: string; image?: string; time: string; type: 'text' | 'image' }> = [
  { id: 1, sender: "Angela Nguyen", message: "Hey everyone! Wasn't the speed friending event so much fun?", time: "2:36 pm", type: 'text'},
  { id: 2, sender: "Riya Patel", message: "OMG YES!", time: "4:04 pm", type: 'text' },
];
