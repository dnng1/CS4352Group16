...
const chatMessages = [
  { id: 1, sender: "Angela Nguyen", message: "Hey everyone! Wasn't the speed friending event so much fun?", time: "2:36 pm"},
  { id: 2, sender: "Riya Patel", message: "OMG YES!", time: "4:04 pm" },
];
