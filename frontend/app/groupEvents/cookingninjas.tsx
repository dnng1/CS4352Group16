...
const chatMessages = [
  { id: 1, sender: "Ananya Desai", message: "Yall!", time: "10:30 pm" },
  { id: 2, sender: "Ananya Desai", message: "Looks like we have a new member! Welcome Alex!", time: "10:32 pm" },
  { id: 3, sender: "Ibrahim Nasser", message: "Hey there Alex!", time: "11:35 pm" },
  { id: 4, sender: "Li Zhang", message: "Welcome Alex!", time: "12:40 AM" },
  { id: 5, sender: "Sophia Sancho", message: "Hola friend!", time: "1:18 AM" },
  { id: 6, sender: "Alex Fischer", message: "Thanks guys! Glad to get to know yall!", time: "8:40 AM" },
];
